...
<body>
    ...
    <header class="navbar" id="mainHeader">
        <div class="container">
            <a href="#" class="logo" id="logoLink">
                <img src="{{ asset('images/mew_logo.png') }}" alt="Mew Logo" style="height: 38px; width: 38px; border-radius: 50%; object-fit: cover; border: 1px solid var(--border-color);" onerror="this.style.display='none'; this.nextElementSibling.style.display='inline-block';">
                <i class="fa-solid fa-camera-retro" style="display: none;"></i>
                <div>
                    MEW CAMERA
    ...
    <section class="testimonials" id="danhgia">
        <div class="container">
            <div class="section-header">
                <div>
                    <span class="section-tag">KHÁCH HÀNG NÓI GÌ VỀ MEW CAMERA</span>
                </div>
            ...
            <div class="cta-banner">
                <div class="cta-content">
                    <h2 class="cta-title">
                        ...
                        <span>CÙNG CÁC THIẾT BỊ TỪ MEW CAMERA?</span>
                    </h2>
                    <p class="cta-desc">
